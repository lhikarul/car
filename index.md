...
<body>
	...
	<header class="header">
		<div class="container-fluid">
			<div class="row align-items-center height">
				<div class="col ml-auto text-right pr-5 col-md-9 text-uppercase">
					<h5 class="title-heading p-2 d-inline-block">the all new</h5>
					<h2 class="my-2 title">2018 mercedes-benz</h2>
					<h3>model name</h3>
					<h6>starts from</h6>
					<h2>$60,000
						<a href="#" class="mx-2">
							<i class="fas fa-play title-icon"></i>
						</a>
					</h2>
				</div>
			</div>
		...
		<div class="container">
			...
			<div class="row mb-5">
				<div class="col d-flex flex-wrap text-uppercase justify-content-center">
					<h1 class="font-weight-blod mx-1">why choose</h1>
			...
			<div class="row">
				...
				<div class="col-sm-6 col-lg-3 text-center my-3">
					...
					<h6 class="text-uppercase font-weight-blod my-3">all brands</h6>
					<div class="skills-underline"></div>
					<p class="w-75 mx-auto text-muted">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Voluptate, unde.</p>
				</div>
				...
				<div class="col-sm-6 col-lg-3 text-center my-3">
					...
					<h6 class="text-uppercase font-weight-blod my-3">free support</h6>
					<div class="skills-underline"></div>
					<p class="w-75 mx-auto text-muted">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Voluptate, unde.</p>
				</div>
				<!-- end of single skill item -->
				...
				<div class="col-sm-6 col-lg-3 text-center my-3">
					...
					<h6 class="text-uppercase font-weight-blod my-3">caring</h6>
					<div class="skills-underline"></div>
					<p class="w-75 mx-auto text-muted">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Voluptate, unde.</p>
				</div>
				<!-- end of single skill item -->
				...
				<div class="col-sm-6 col-lg-3 text-center my-3">
					...
					<h6 class="text-uppercase font-weight-blod my-3">affordable</h6>
					<div class="skills-underline"></div>
					<p class="w-75 mx-auto text-muted">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Voluptate, unde.</p>
				</div>
				<!-- end of single skill item -->
	...
	<section class="inventory py-5" id="inventory">
		<div class="container">
			...
			<div class="row mb-5">
				<div class="col d-flex flex-wrap text-uppercase justify-content-center">
					<h1 class="font-weight-blod mx-1">our</h1>
			...
			<div class="row inventory-container">
				...
				<div class="col-10 mx-auto my-3 col-md-6 col-lg-4">
					<div class="card car-card">
						<img src="img/car-german-1.jpeg" class="card-img" alt="">
						<!-- card body -->
						<div class="card-body">
				...
				<div class="col-10 mx-auto my-3 col-md-6 col-lg-4">
					<div class="card car-card">
						<img src="img/car-american-1.jpeg" class="card-img" alt="">
						<!-- card body -->
						<div class="card-body">
							<div class="car-info d-flex justify-content-between">
								<!-- first flex child -->
				...
				<div class="col-10 mx-auto my-3 col-md-6 col-lg-4">
					<div class="card car-card">
						<img src="img/car-german-2.jpeg" class="card-img" alt="">
						<!-- card body -->
						<div class="card-body">
							<div class="car-info d-flex justify-content-between">
								<!-- first flex child -->
				...
				<div class="col-10 mx-auto my-3 col-md-6 col-lg-4">
					<div class="card car-card">
						<img src="img/car-american-2.jpeg" class="card-img" alt="">
						<!-- card body -->
						<div class="card-body">
							<div class="car-info d-flex justify-content-between">
								<!-- first flex child -->
				...
				<div class="col-10 mx-auto my-3 col-md-6 col-lg-4">
					<div class="card car-card">
						<img src="img/car-german-3.jpeg" class="card-img" alt="">
						<!-- card body -->
						<div class="card-body">
							<div class="car-info d-flex justify-content-between">
								<!-- first flex child -->
				...
				<div class="col-10 mx-auto my-3 col-md-6 col-lg-4">
					<div class="card car-card">
						<img src="img/car-american-3.jpeg" class="card-img" alt="">
						<!-- card body -->
						<div class="card-body">
							<div class="car-info d-flex justify-content-between">
								<!-- first flex child -->
	...
	<div class="section question py-5" id="question">
		<div class="container">
			<div class="row">
				...
				<div class="col-10 mx-auto my-2 p-4 col-md-6 d-flex justify-content-between question-grey">
					<!-- first flexbox child -->
					...
					<div class="question-text w-75">
						<h4 class="quetstion-title text-capitalize font-weight-bold">
							Are you looking for a car?
						</h4>
						<p class="question-info">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Culpa, voluptatem?</p>
					</div>
				</div>
				<!-- single question second -->
				<div class="col-10 mx-auto my-2 p-4 col-md-6 d-flex justify-content-between question-yellow">
					<!-- first flexbox child -->
					<a href="#" class="question-icon mr-3">
	...
	<section class="featured py-5" id="featured">
		...
		<!-- section title -->
			<div class="row mb-5">
				<div class="col d-flex flex-wrap text-uppercase justify-content-center">
					<h1 class="font-weight-blod mx-1">featured</h1>
			...
			<div class="row">
				...
				<div class="col-10 mx-auto col-lg-6 featured-info my-3">
					...
					<div class="featured-item my-3 d-flex p-2 text-capitalize align-items-baseline flex-wrap">
						...
						<h5 class="font-weight-bold mx-1"><strong class="car-maker">mercedes</strong></h5>
			...
			<div class="row">
				<div class="col-sm-6">
					<div class="gallery-item">
						<img src="img/car-american-1.jpeg" alt="" class="img-fluid gallery-img">
					</div>
				</div>
				<!-- end of first column -->
				<div class="col-sm-6 d-flex flex-column justify-content-between">
					<div class="row">
						...
						<div class="col-sm-6">
							<div class="gallery-item">
								<img src="img/car-american-2.jpeg" alt="" class="img-fluid gallery-img">
							</div>
						</div>
						<!-- second item -->
						<div class="col-sm-6">
							<div class="gallery-item">
								<img src="img/car-american-3.jpeg" alt="" class="img-fluid gallery-img">
							</div>
						</div>
					</div>
					...
					<div class="row">
						...
						<div class="col-sm-6">
							<div class="gallery-item">
								<img src="img/car-american-4.jpeg" alt="" class="img-fluid gallery-img">
							</div>
						</div>
						<!-- second item -->
						<div class="col-sm-6">
							<div class="gallery-item">
								<img src="img/car-american-5.jpeg" alt="" class="img-fluid gallery-img">
							</div>
						</div>
					</div>
					<!-- end of second column -->
	...
	<section class="services py-5 d-flex align-items-center" id="services">
		...
		<div class="video-container">
			<video class="video-item" autoplay loop muted>
				<source src="video/videoBcg.mp4" type="video/mp4">your browser dose not support video tag
			</video>
		</div>
			...
			<div class="row my-3">
				...
				<div class="col-8 mx-auto col-lg-6 col-md-4 my-3">
					<div class="service py-5 pl-4">
						...
						<h5 class="text-uppercase font-weight-blod">repair</h5>
					</div>
				</div>
				<!-- end of col -->
				<!-- col -->
				<div class="col-8 mx-auto col-lg-6 col-md-4 my-3">
					<div class="service py-5 pl-4">
						...
						<h5 class="text-uppercase font-weight-blod">replacement</h5>
					</div>
				</div>
				<!-- end of col -->
				<!-- col -->
				<div class="col-8 mx-auto col-lg-6 col-md-4 my-3">
					<div class="service py-5 pl-4">
						...
						<h5 class="text-uppercase font-weight-blod">assistance</h5>
					</div>
				</div>
				<!-- end of col -->
			</div>
	...
	<section class="quotes py-5 my-5" id="quotes">
		<div class="container">
			...
			<div class="row mb-5">
				<div class="col d-flex flex-wrap text-uppercase justify-content-center">
					<h1 class="font-weight-blod mx-1">what</h1>
					<h1 class="section-title-special mx-1">they say</h1>
				</div>			
			</div>
		<!-- end of section title -->
		<div class="row">
			...
			<div class="col-10 mx-auto my-5 col-md-6 col-lg-4">
				<div class="card">
					...
					<div class="card-body text-center customer-card-body">
						<img src="img/customer-1.jpg" class="rounded-circle customer-img" alt="">
						<div class="card-title">
							<h5 class="customer-name text-capitalize">customer name</h5>
						</div>
						<h6 class="customer-job text-capitalize">customer job</h6>
						<p class="customer-quote text-left">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Eum, molestiae.</p>
						<span class="customer-icon"><i class="fas fa-quote-left"></i></span>
					</div>
			...
			<div class="col-10 mx-auto my-5 col-md-6 col-lg-4">
				<div class="card">
					...
					<!-- card body -->
					<div class="card-body text-center customer-card-body">
						<img src="img/customer-2.jpg" class="rounded-circle customer-img" alt="">
						<div class="card-title">
							<h5 class="customer-name text-capitalize">customer name</h5>
						</div>
						<h6 class="customer-job text-capitalize">customer job</h6>
			...
			<div class="col-10 mx-auto my-5 col-md-6 col-lg-4">
				<div class="card">
					...
					<!-- card body -->
					<div class="card-body text-center customer-card-body">
						<img src="img/customer-3.jpg" class="rounded-circle customer-img" alt="">
						<div class="card-title">
							<h5 class="customer-name text-capitalize">customer name</h5>
						</div>
						<h6 class="customer-job text-capitalize">customer job</h6>
